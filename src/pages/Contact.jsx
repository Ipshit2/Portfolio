...
function Contact() {
  ...
  return (
    <div className='my-[20px] h-[700px] mx-[20px]' id='contact'>
        <h1 className='font-bold text-center lg:text-left text-[40px] lg:text-[100px] text-[#5c618b] leading-tight font-Pop pt-[20px] mt-[150px]'>LET'S WORK <br /> TOGETHER</h1>
        <form name='form' className='my-[20px] font-Pop' onSubmit={SubmitForm}>
            <div className='flex  space-x-2'>
                <div className='w-[50%]'>
                    <h1 className='text-[14px] pt-[10px] text-[#E2DFD2]'>NAME</h1>
                ...
                <div className='w-[50%]'>
                    <h1 className='email text-[14px] pt-[10px] text-[#E2DFD2]'>EMAIL ADDRESS</h1>
            ...
            <div>
                <h1 className='text-[14px] pt-[10px] text-[#E2DFD2]'>MESSAGE</h1>
            ...
            <div>
                <button className='bg-[#5c618b] w-full h-auto py-[10px] mt-[10px] rounded-xl font-medium' type='submit'>SUBMIT</button>
            </div>
        </form>
