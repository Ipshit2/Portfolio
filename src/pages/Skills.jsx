...
function Skills() {
  return (
    <div className='my-[20px] h-auto mx-[20px]' id='skills'>
        <h1 className='font-bold text-center lg:text-left text-[40px] lg:text-[100px] text-[#5c618b] leading-tight font-Pop pt-[20px] mt-[150px]'>SKILLS</h1>
        <h1 className='text-[#5c618b] text-center lg:text-left font-Pop font-bold text-[25px] mt-[10px]'>Technical Skills</h1>
